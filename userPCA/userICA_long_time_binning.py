...
try:
    ...
    def handle_community2ica(com):
        try:
            ret = (com, userActivityFunctions.community2Pca(df, com, 'tbin', graphtype=nx.DiGraph,
                                                            excludeDiagonal=True, fitFunction=misc.icaFit,
                                                            fitFunctionKwargs={'max_iter': 1500,
    ...
    savename = 'ica_result_community.pickle'  # noqa
