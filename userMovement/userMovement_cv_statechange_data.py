...
import logging
logging.basicConfig(filename='userMovement_sgd_statechange.log', level=logging.INFO,
                    format="%(asctime)s :: %(filename)s:%(lineno)s :: %(funcName)s() ::    %(message)s")
logger = logging.getLogger('userMovement_sgd_statechange')
...
try:
    ...
    fig.savefig(f'figs/userMovement_cv_roc_curve_statechange.pdf')
    with open("usermove_statechange.pkl", 'bw') as fid:
        pickle.dump(est, fid)
